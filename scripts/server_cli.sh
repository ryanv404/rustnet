...
./target/debug/server \
    ...
    --text-route 'get:/many_method:Hi from the GET route!' \
    --text-route 'head:/many_method:Hi from the HEAD route!' \
    --text-route 'post:/many_method:Hi from the POST route!' \
    --text-route 'put:/many_method:Hi from the PUT route!' \
    --text-route 'patch:/many_method:Hi from the PATCH route!' \
    --text-route 'delete:/many_method:Hi from the DELETE route!' \
    --text-route 'trace:/many_method:Hi from the TRACE route!' \
    --text-route 'options:/many_method:Hi from the OPTIONS route!' \
    --text-route 'connect:/many_method:Hi from the CONNECT route!' \
